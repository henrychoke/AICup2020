...
#######
img_path = r'C:\Users\user\Desktop\Aldea\secondrelease\outputcut\00058.jpg'
img = cv2.imread(img_path, cv2.IMREAD_GRAYSCALE)
#寫column name
with open('tamura.csv', 'a',newline="") as csvfile:
    writer = csv.writer(csvfile)
  # 寫入一列資料
    writer.writerow(['coarseness', 'contrast', 'directionality','roughness'])
#測試
...
frou= roughness(fcrs,fcon)
print("roughness: %f" % frou)
#寫成函式
for jpgfile in glob.glob(r'C:\Users\user\Desktop\Aldea\secondrelease\outputcut\*.jpg'):
    ...
    with open('tamura.csv', 'a',newline="") as csvfile:
        writer = csv.writer(csvfile)
      # 寫入一列資料
        writer.writerow([fcrs, fcon,fdir,frou])
